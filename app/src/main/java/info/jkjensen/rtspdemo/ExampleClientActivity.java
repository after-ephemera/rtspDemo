...
public class ExampleClientActivity extends Activity implements
        OnClickListener,
        RtspClient.Callback,
        Session.Callback,
    ...
    public final static String TAG = "ExampleClientActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences mPrefs = PreferenceManager.getDefaultSharedPreferences(ExampleClientActivity.this);
    ...
    private void logError(final String msg) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ExampleClientActivity.this);
